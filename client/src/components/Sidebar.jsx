...
const Sidebar = () => {
  ...
  const [confirmingId, setConfirmingId] = useState(null); // for confirmation
  const [addedIds, setAddedIds] = useState([]); // for visual feedback
      ...
      {showSearchResults ? (
        <div className="flex flex-col gap-2 mt-4">
          {searchResults.map((user, index) => (
            <div
              key={index}
              className="flex items-center justify-between bg-[#282142] p-2 rounded-lg cursor-pointer"
            >
